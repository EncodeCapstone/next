          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="text-black">
                ...
                <li className="mb-4">
                  <a
                    href="https://github.com/boninggong"
                    className="font-sans text-base hover:underline "
                  >
                    boninggong
                  </a>
                ...
                <li className="mb-4">
                  <a
                    href="https://github.com/kurmanto"
                    className="font-sans text-base hover:underline"
                  >
                    tomer
                  </a>
                ...
                <li>
                  <a
                    href="https://github.com/SaschaKubisch"
                    className="font-sans text-base hover:underline"
                  >
                    sascha
                  </a>
            ...
            <div>
              ...
              <ul className="text-black">
                <li className="mb-4">
                  <a href="#" className="font-sans text-base hover:underline">
                    Privacy Policy
                  </a>
                </li>
                <li>
